---
title: Подключение классификатора STS
source_url: https://developers.sber.ru/docs/ru/va/code/nlp/classificator/connection-classificator
...
- title: Настройка конфигурационного файла
  level: 2
  id: nastroyka-konfiguratsionnogo-fayla2
- title: Настройка параметров классификации
  level: 2
  id: nastroyka-parametrov-klassifikatsii2
- title: Конфигурация алгоритма классификатора
  level: 2
  id: konfiguratsiya-algoritma-klassifikatora2
- title: morphology
  level: 3
  id: morphology2
- title: tokenizer
...
- title: lengthLimit, timeLimit
  level: 3
  id: length-limit-time-limit2
- title: engine
  level: 3
  id: engine2
- title: noMatchThreshold
  level: 3
  id: no-match-threshold2
- title: 'parameters: algorithm'
  level: 3
  id: parameters-algorithm2
---
...
[![](/assets/nlp/classificator/connection-classificator/Brain.png)
Brain](../overview.md)[![](/assets/nlp/classificator/connection-classificator/Code.png)
Code](../../overview.md)
