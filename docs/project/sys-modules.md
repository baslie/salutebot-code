---
title: Модули sys.modules в Code
source_url: https://developers.sber.ru/docs/ru/va/code/project/sys-modules
reading_time: 1
badges:
- Code
breadcrumbs:
...
[![](/assets/project/sys-modules/Code.png)
Code](../overview.md)
