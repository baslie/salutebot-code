---
title: Теги тестирования в Code
source_url: https://developers.sber.ru/docs/ru/va/code/testing/test-tags
reading_time: 5
badges:
- Code
breadcrumbs:
...
- title: Тег requestData
  level: 2
  id: teg-request-data2
- title: Тег responseData
  level: 2
  id: teg-response-data2
- title: Тег state
  level: 2
  id: teg-state2
- title: Тег test-case
...
[![](/assets/testing/test-tags/Code.png)
Code](../overview.md)
...
* `body` — описание тела (HTTP message body) запроса, Необязательный элемент.
  + атрибут `strictMatch` — строгость сопоставления. По умолчанию: false.
    ...
    В случае нестрого сопоставления, мок подходит, если все значения полей из json-объекта равны соответствующим значениям полей `HTTP message body` запроса.
